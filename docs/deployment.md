...
- **From a browser:** Programmer > Settings > Network > **This Device's Network** offers the same controls plus a hostname field. When you change the address you're connected through, the Programmer becomes unreachable at the old address — the confirmation dialog shows the new URL to reconnect to.
