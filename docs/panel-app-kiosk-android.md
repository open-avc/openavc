...
Soft kiosk is enough for staff-only spaces, huddle spaces, and temporary installs.

### Tier 2: True Kiosk (Device Owner)
...
**What true kiosk adds on top of soft kiosk:**
...
## Soft vs. True Kiosk at a Glance

| | Soft Kiosk | True Kiosk |
|---|---|---|
...
**The app was provisioned but the kiosk toggle says "Soft kiosk".**
...
Confirm the kiosk toggle is on in Kiosk settings. If it's on and the panel still doesn't auto-launch, the manufacturer may have stripped the BOOT_COMPLETED broadcast; a few budget tablet OEMs do this. Try a different brand or escalate through [community support](https://github.com/open-avc/openavc-panel-app/issues).
...
- [iOS kiosk setup](panel-app-kiosk-ios.md)
