...
hiddenimports = [
    ...
    'server.core.plugin_artifacts',
    'server.core.plugin_wheels',
    'server.core.plugin_native_deps',
    ...
    'server.api.routes.cloud',
    'server.api.routes.devices',
    'server.api.routes.driver_test',
    'server.api.routes.drivers',
    'server.api.routes.host',
    'server.api.routes.ir_db',
    'server.api.routes.isc',
    'server.api.routes.macros',
    'server.api.routes.network',
    'server.api.routes.pair',
    'server.api.routes.project',
    'server.api.routes.push',
    'server.api.routes.python_drivers',
    'server.api.routes.root',
    'server.api.routes.scripts',
    'server.api.routes.setup',
    'server.api.routes.simulation',
    'server.api.routes.system',
    'server.api.routes.tls',
    'server.api.routes.updates',
