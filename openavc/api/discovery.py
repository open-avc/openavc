...
async def _build_port_labels(engine: DiscoveryEngine) -> dict[str, str]:
    ...
    """
    from openavc.discovery.port_scanner import BASELINE_PORTS
...
async def get_config() -> dict[str, Any]:
    ...
    from openavc.discovery.scan_budget import depth_total_seconds
...
async def add_device(req: AddDeviceRequest) -> dict[str, Any]:
    ...
    if discovered and discovered.open_ports:
        from openavc.core.web_ui_probe import web_ui_url_from_open_ports
...
async def install_and_match(req: InstallAndMatchRequest) -> dict[str, Any]:
    ...
    """
    from openavc.api.rest import install_community_driver, CommunityDriverInstallRequest
