...
from openavc.utils.community_integrity import CommunityArtifactError
...
async def list_installed() -> dict[str, Any]:
    ...
    from openavc.core.plugin_installer import list_installed_plugins
...
async def get_plugin_data_info_endpoint(plugin_id: str) -> dict[str, Any]:
    ...
    """
    from openavc.core.plugin_installer import get_plugin_data_info
