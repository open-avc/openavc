...
class MacroToolsMixin:
    ...
    async def _add_variable(self, input: dict) -> Any:
        ...
        from openavc.cloud.ai_tool_handler import _validate_variable
    ...
    async def _update_macro(self, input: dict) -> Any:
        ...
        from openavc.core.macro_validation import validate_macro
        from openavc.core.project_loader import MacroConfig
        from openavc.cloud.tools.ui_tools import _merge_forward_compat
    ...
    async def _execute_macro(self, input: dict) -> Any:
        macro_id = input.get("macro_id", "")
        from openavc.api._engine import _test_call_retry_after
