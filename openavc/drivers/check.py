"""Contract-check one driver file from a terminal.
    ...
    python -m openavc.drivers.check path/to/driver.py
    python -m openavc.drivers.check path/to/driver.avcdriver
    python -m openavc.drivers.check path/to/drivers/        # whole directory
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m openavc.drivers.check",
        description=(
        ...
        epilog=(
            "Examples:\n"
            "  python -m openavc.drivers.check my_projector.py\n"
