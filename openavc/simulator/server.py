...
from openavc.simulator.api import router as api_router, ws_endpoint, set_auto_shutdown, set_manager
...
async def lifespan(app: FastAPI):
    ...
    if parent_pid:
        from openavc.simulator.parent_watch import watch_parent
