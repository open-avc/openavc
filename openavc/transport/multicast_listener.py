...
class _PortListener:
    ...
    def join_group(self, group: str, control_ip: str, name: str) -> None:
        ...
        if group in self.groups:
            ...
            return
        from openavc.discovery.multicast import join_group_on_interfaces
    ...
    def _leave_group(self, group: str) -> None:
        ...
        if self._sock is None:
            return
        from openavc.discovery.multicast import ANY_INTERFACE
...
def _local_addresses(name: str, host: str) -> set[str]:
    ...
    if not local:
        ...
        try:
            from openavc.discovery.network_scanner import get_default_route_ip
