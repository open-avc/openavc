...
from openavc.updater.checker import ReleaseInfo, UpdateChecker
...
class UpdateManager:
    ...
    def __init__(
        ...
        if project_path is None:
            from openavc import config as server_config
    ...
    async def apply_update(self) -> dict[str, Any]:
        ...
        try:
            ...
            from openavc.updater.backup import create_backup, cleanup_old_backups
            ...
            from openavc.updater.rollback import write_pending_marker
    ...
    def _apply_windows(self, artifact_path: Path, new_version: str) -> None:
        ...
        """
        from openavc.updater.rollback import _launch_installer_via_scheduler
    ...
    def _cleanup_failed_apply(self, to_version: str, error_msg: str) -> None:
        ...
        """
        from openavc.updater.rollback import clear_pending_marker
        try:
    ...
    async def rollback(self) -> dict[str, Any]:
        ...
        from openavc.system_config import APP_DIR
    ...
    def get_status(self) -> dict[str, Any]:
        ...
        from openavc.updater.rollback import can_rollback
        from openavc.system_config import APP_DIR
        ...
        if has_rollback:
            ...
            from openavc.updater.rollback import rollback_target_version
