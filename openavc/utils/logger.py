...
from openavc.utils.log_redaction import SecretRedactionFilter
...
def _build_file_handler(formatter: logging.Formatter) -> logging.Handler | None:
    ...
    """
    from openavc.system_config import get_log_dir, get_system_config
...
def _configure_root():
    ...
    from openavc.utils.log_buffer import get_log_buffer, BufferHandler
    ...
    # log stays empty.
    logging.getLogger("openavc.transport").setLevel(logging.DEBUG)
...
def get_logger(name: str) -> logging.Logger:
    ...
    Args:
        name: Module name, typically __name__ (e.g., "openavc.core.state_store")
