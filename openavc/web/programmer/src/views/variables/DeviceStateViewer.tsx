        ...
        <div style={{ flex: 1, overflow: "auto" }}>
          {devices.length === 0 ? (
            ...
            Array.from(deviceGroups.entries()).map(([group, groupDevices]) => (
              <div key={group}>
                {deviceGroups.size > 1 && (
                  <div style={{ padding: "var(--space-sm) var(--space-md) 2px", fontSize: "var(--font-size-xs)", color: "var(--text-muted)", fontWeight: "var(--font-weight-semibold)", textTransform: "uppercase", letterSpacing: "var(--tracking-wide)" }}>
                    {group}
                  </div>
                )}
                {groupDevices.map((d) => {
        ...
        {selectedDevice ? (
          <div style={{ padding: "var(--space-lg)" }}>
            ...
            {stateEntries.length === 0 ? (
              ...
              <>
              {/* Column header */}
              <div style={{ display: "flex", alignItems: "center", gap: "var(--space-sm)", padding: "0 var(--space-md) 4px", fontSize: "var(--font-size-2xs)", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "var(--tracking-wide)" }}>
