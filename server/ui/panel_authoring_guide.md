...
| matrix | 277 x 234 px | 21.64% x 29.25% | matrix-cell 44 x 44 |
...
- **matrix** -- Constant, NOT a function of the crosspoint count: 2x2, 3x3 and 4x4 all floor here, because .matrix-scroll scrolls the grid internally once it runs out of room.
