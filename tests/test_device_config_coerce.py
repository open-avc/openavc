...
the pure helper on the fly with the esbuild already in openavc/web/programmer/node_modules
...
SOURCE = (
    OPENAVC_ROOT / "openavc" / "web" / "programmer" / "src" / "views" / "devices" / "deviceConfigCoerce.ts"
)
