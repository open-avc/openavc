...
#: template literal and defines them there, so they resolve correctly at
#: runtime; this scan only reads ``tokens.css``, which is why it cannot see
#: that. tests/test_theme_contrast.py does read the TSX, and holds them.
#:
