...
HELPERS = (
    OPENAVC_ROOT / "openavc" / "web" / "programmer" / "src" / "components" / "ui-builder" / "uiBuilderHelpers.ts"
)
...
SCENARIOS = [
    ...
    "rename_moves_placements",
    "rename_leaves_unplaced_layouts_alone",
    "rename_reparents_children",
