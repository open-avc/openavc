...
export interface DriverDefinition {
  ...
  verified?: boolean;
  /**
   * The device exposes a browser-reachable web interface. true auto-adds an
   * 'Open Web UI' button (opens https://{host}); a string is used as the URL
   * template (e.g. "http://{host}:8080") with {host}/{port}/{config_key}
   * substitution. Requires platform >= 0.24.0.
   */
