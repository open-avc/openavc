...
function buildGalleryPage(): UIPage {
  const elements: UIElement[] = [
    ...
    },
    {
      ...
      max: 100,
      unit: "%",
      grid_area: { col: 1, row: 6, col_span: 4, row_span: 4 },
      style: {},
    ...
    },
    {
      ...
      grid_area: { col: 5, row: 6, col_span: 1, row_span: 4 },
      style: {},
    ...
    },
    {
      ...
      max: 10,
      orientation: "vertical",
      grid_area: { col: 6, row: 6, col_span: 3, row_span: 4 },
      style: {},
    ...
    },
    {
      ...
      grid_area: { col: 9, row: 6, col_span: 4, row_span: 4 },
      style: {},
    ...
    },
    {
      ...
      keypad_style: "phone",
      show_display: true,
      grid_area: { col: 13, row: 6, col_span: 4, row_span: 4 },
      style: {},
      bindings: {},
    },
    {
      ...
      matrix_config: {
        input_count: 4,
        output_count: 4,
        input_labels: ["Cam 1", "Cam 2", "PC", "Doc"],
        output_labels: ["Main", "Conf", "Stream", "Record"],
        route_key_pattern: "gallery.route.*",
      },
      grid_area: { col: 1, row: 10, col_span: 8, row_span: 5 },
      style: {},
      bindings: {},
    },
    {
      id: "g_label_card",
      type: "label",
      text: "Surface card example. Shows the surface and surface_border theme variables.",
      grid_area: { col: 9, row: 10, col_span: 8, row_span: 5 },
      style: {
        bg_color: "var(--panel-surface)",
        border_width: 1,
        border_color: "var(--panel-surface-border)",
        border_radius: 8,
        padding: 12,
        white_space: "normal",
      },
...
const GALLERY_DEMO_STATE: Record<string, unknown> = {
  ...
  "gallery.route.Stream": "Cam 2",
  "gallery.route.Record": "Cam 1",
};
